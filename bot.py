...
async def server_info_command(message):
    create_graph()
    await bot.send_photo(message.chat.id, photo=open('/home/pi/Documents/my_pi_server/photos/graph1.png', 'rb'))
    await bot.send_photo(message.chat.id, photo=open('/home/pi/Documents/my_pi_server/photos/graph2.png', 'rb'))
...
async def scheduler():
    aioschedule.every(10).minutes.do(collect_statistic)
    while True:
